...
public class Demo_Thread extends BaseTest {
    WebDriver driver;
    ...
    @BeforeClass
    public void beforeClass(String browser,String url,String env){
        this.env = env;
        driver = openBrowserHandleInterFaceDemoThread(browser,url);
