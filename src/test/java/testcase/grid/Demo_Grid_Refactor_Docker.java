...
public class Demo_Grid_Refactor_Docker extends BaseTest {
    WebDriver driver;
    ...
    @Parameters({"browser","url","osName","ipAddress","port","environment","osVersion"})
    @BeforeClass
    public void beforeClass(String browser,String url,String osName,String ipAddress,String port,String env,String osVersion){
        this.env = env;
        driver = getDriver(browser,url,env,ipAddress,port,osName,osVersion);
