...
public class Demo_Grid_Cloud_Testing_BrowserStack extends BaseTest {
    WebDriver driver;
    ...
    @BeforeClass
    public void beforeClass(String browser,String url,String osName,String osVersion){
        driver = openBrowserGrid_BrowserStack(browser,url,osName,osVersion);
