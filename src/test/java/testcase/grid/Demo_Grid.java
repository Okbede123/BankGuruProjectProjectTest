...
public class Demo_Grid extends BaseTest {
    WebDriver driver;
    ...
    @BeforeClass
    public void beforeClass(String browser,String url,String osName,String ipAddress,String port){
        driver = openBrowserGrid(browser,url,osName,ipAddress,port);
